...
export const CONFIGURATION_MAPPING: ValueMapping = {
    isMainTweaks: {
        ...
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs2.lua'], false: undefined },
    },
    ...
    difficulty: {
        ...
        values: {
            Default: undefined,
            'Very Easy': ['!%%MODE%%_difficulty veryeasy'],
            Easy: ['!%%MODE%%_difficulty easy'],
            Normal: ['!%%MODE%%_difficulty normal'],
            Hard: ['!%%MODE%%_difficulty hard'],
            'Very Hard': ['!%%MODE%%_difficulty veryhard'],
            Epic: ['!%%MODE%%_difficulty epic'],
        },
    },
    enemyHealth: {
        ...
        type: 'tweakdefs',
        values: {
            '1.3x': ['~lua/tweakdefs/raptor hp 1.3X.lua'],
            '1.5x': ['~lua/tweakdefs/raptor hp 1.5X.lua'],
            '1.7x': ['~lua/tweakdefs/raptor hp 1.7X.lua'],
            '2.0x': ['~lua/tweakdefs/raptor hp 2.0X.lua'],
            '2.5x': ['~lua/tweakdefs/raptor hp 2.5X.lua'],
            '3.0x': ['~lua/tweakdefs/raptor hp 3.0X.lua'],
            '4.0x': ['~lua/tweakdefs/raptor hp 4.0X.lua'],
            '5.0x': ['~lua/tweakdefs/raptor hp 5.0X.lua'],
        },
    },
    bossHealth: {
        ...
        type: 'tweakdefs',
        values: {
            '1.3x': ['~lua/tweakdefs1/queen hp 01 1.3X.lua'],
            '1.5x': ['~lua/tweakdefs1/queen hp 02 1.5X.lua'],
            '1.7x': ['~lua/tweakdefs1/queen hp 03 1.7X.lua'],
            '2.0x': ['~lua/tweakdefs1/queen hp 04 2.0X.lua'],
            '2.5x': ['~lua/tweakdefs1/queen hp 04 2.5X.lua'],
            '3.0x': ['~lua/tweakdefs1/queen hp 05 3.0X.lua'],
            '4.0x': ['~lua/tweakdefs1/queen hp 06 4.0X.lua'],
            '5.0x': ['~lua/tweakdefs1/queen hp 07 5.0X.lua'],
            '7.0x': ['~lua/tweakdefs1/queen hp 08 7.0X.lua'],
            '9.0x': ['~lua/tweakdefs1/queen hp 09 9.0X.lua'],
            '11.0x': ['~lua/tweakdefs1/queen hp 10 11.0X.lua'],
            '13.0x': ['~lua/tweakdefs1/queen hp 11 13.0X.lua'],
        },
    },
    extras: {
        description: 'Mini Bosses',
        type: 'tweakdefs',
        values: { None: undefined, 'Mini Bosses': ['~lua/tweakdefs4.lua'] },
    },
    gameMap: {
        description: 'Map',
        type: 'command',
    ...
    isCrossFactionT2: {
        ...
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs6.lua'], false: undefined },
    },
    isT3Eco: {
        description: 'T3 Economy buildings',
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs7.lua'], false: undefined },
    },
    isT3Builders: {
        description: 'T3 Builder aides',
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs8.lua'], false: undefined },
    },
    isUnitLaunchers: {
        description: 'Unit Launchers',
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs9.lua'], false: undefined },
    },
    isLrpcRebalance: {
        description: 'LRPC Rebalance',
        type: 'tweakunits',
        values: { true: ['~lua/tweakunits6.lua'], false: undefined },
    },
    isT4Defences: {
        description: 'T4 Defences',
        type: 'tweakdefs',
        values: { true: ['~lua/tweakdefs3.lua'], false: undefined },
    },
    isT4AirRework: {
        description: 'T4 Air Rework',
        type: 'tweakunits',
        values: { true: ['~lua/tweakunits7.lua'], false: undefined },
    },
    isMegaNuke: {
        description: 'Mega Nuke',
        type: 'tweakunits',
        values: { true: ['~lua/tweakunits4.lua'], false: undefined },
    },
} as const;
